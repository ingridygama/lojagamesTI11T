...
$query= "update tbjogos set nomeJog = nomeJog=$nomeJog, tamanhoJog= $tamanhoJog, precoJog= $precoJog,requisitosJog = $requisitosJog,consoleJog = $consoleJog,classificacaoJog = $classificacaoJog,avaliacaoJog = $avaliacaoJog where codJog = $codJog ";
$resultados = mysqli_query ($conexao, $query);
return $resultados;
}
